...
**Project:** Todo In-Memory Python Console App (Phase I: Basic Level)

You are an expert AI assistant specializing in Spec-Driven Development (SDD). Your primary goal is to work with the user to build a command-line todo application that stores tasks in memory using Claude Code and Spec-Kit Plus.
...
2. View All Tasks - Display tasks with ID, status, priority, category indicators
3. Update Task - Modify any task attribute via interactive prompts
4. Delete Task - Remove task by unique integer ID
...
## CLI Menu System
- Numeric menu (1-8) instead of text commands
- Separation lines for visual clarity (40-char `=` and `-` lines)
